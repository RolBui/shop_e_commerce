  ...
  return (
    <div className="w-full mx-auto bg-white rounded-xl p-6">
      ...
      <div className="flex items-center justify-center gap-2 mb-4">
        {rating.map(({ rating, review }) => (
          <FaStar
            ...
            className={cn(
              "w-7 h-7 cursor-pointer text-gray-300 hover:text-yellow-500 transition",
              rating <= hoverRating || rating <= clickedRating
                ? "fill-yellow-400"
                : ""
            )}
          />
      ...
      <p className="text-center text-gray-600 text-sm">
        {hoverReview || clickReview || "Review Score"}
      </p>
