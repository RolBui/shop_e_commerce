...
import Button from "../uiCompoments/Button";
  ...
  return (
    <div className="flex items-center justify-between gap-6 border-b border-gray-200 py-4 mb-6 w-full flex-wrap bg-white px-4 rounded-lg shadow-sm">
      ...
      <div className="flex items-center justify-center gap-2 bg-gray-100 px-2 py-1 rounded-md">
        ...
        <button className="p-2 rounded-md bg-white border hover:bg-gray-200 transition disabled:opacity-50 disabled:cursor-not-allowed">
          <CiSquareMinus className="w-5 h-5 text-gray-700" />
        </button>
        ...
        <button className="p-2 rounded-md bg-white border hover:bg-gray-200 transition">
          <CiSquarePlus className="w-5 h-5 text-gray-700" />
        </button>
      </div>

      {/* Subtotal Price */}
      <p className="text-lg font-semibold text-gray-800">${100.0}</p>

      {/* Remove Item Button */}
      <button className="p-2 rounded-md bg-red-50 hover:bg-red-100 transition text-red-500 border border-red-300">
        <FaTimes className="w-5 h-5" />
      </button>

      {/* Update Cart Button */}
      <Button className="update-item-btn">Update Cart</Button>
    </div>
  );
};
